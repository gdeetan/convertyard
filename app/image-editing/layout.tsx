...
const meta = CATEGORY_META['image-editing']

export const metadata: Metadata = {
  title: { absolute: meta.seoTitle },
  description: meta.seoDescription,
  alternates: { canonical: 'https://convertyard.com/image-editing' },
  openGraph: {
    title: meta.seoTitle,
    description: meta.seoDescription,
    url: 'https://convertyard.com/image-editing',
  },
}
...
export default function ImageEditingLayout({ children }: { children: React.ReactNode }) {
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Image Editing', item: 'https://convertyard.com/image-editing' },
    ],
  }
  return (
    <>
