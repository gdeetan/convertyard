...
const meta = CATEGORY_META['web-tools']

export const metadata: Metadata = {
  title: meta.seoTitle,
  description: meta.seoDescription,
  alternates: { canonical: 'https://convertyard.com/web-tools' },
  openGraph: {
    title: meta.seoTitle,
    description: meta.seoDescription,
    url: 'https://convertyard.com/web-tools',
  },
}
...
export default function WebToolsLayout({ children }: { children: React.ReactNode }) {
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Web Tools', item: 'https://convertyard.com/web-tools' },
    ],
  }
  return (
    <>
