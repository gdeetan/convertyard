...
export default function PdfToJpgPage() {
  ...
  const deselectAll = (fileIdx: number) => {
    setEntries(prev => prev.map((e, i) =>
                              ...
                              return (
                                <div key={`${entry.id}-${pageIndex}`} className="relative">
                                  ...
                                  <button
                                    ...
                                    className={cn(
                                      'absolute top-1 right-1 rounded w-4 h-4 border flex items-center justify-center',
                                      selected
