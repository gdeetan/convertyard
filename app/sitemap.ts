...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticEntries: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/convertyard-vs-smallpdf/`,       lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7  },
    { url: `${BASE_URL}/convertyard-vs-convertio/`,      lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7  },
    { url: `${BASE_URL}/convertyard-vs-ilovepdf/`,       lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7  },
    { url: `${BASE_URL}/convertyard-vs-adobe-acrobat/`,  lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7  },
