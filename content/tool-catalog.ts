...
export const ALL_TOOLS: CatalogTool[] = [
  ...
  { slug: 'png-to-bmp',   title: 'PNG to BMP',   description: 'Convert PNG to uncompressed BMP for legacy toolchains and game engines.', category: 'images', status: 'live' },
  { slug: 'raw-to-png',   title: 'RAW to PNG',   description: 'Convert DNG camera RAW files to lossless PNG locally — no uploads.', category: 'images', status: 'live' },
  ...
  { slug: 'flv-to-mp4',  title: 'FLV to MP4',   description: 'Convert legacy Flash Video files to MP4. Batch convert in your browser — no uploads.', category: 'video-audio', status: 'live' },
  ...
  { slug: 'add-captions-to-video', title: 'Add Captions to Video', description: 'Auto-transcribe with Whisper and add captions — burn them in or mux a soft subtitle track. No uploads.', category: 'video-audio', status: 'live' },
  ...
  { slug: 'image-upscaler',      title: 'Image Upscaler',      description: 'Upscale photos 2×–8× with on-device AI. Graphics use Lanczos.', category: 'ai-tools', status: 'live', badge: 'AI' },
