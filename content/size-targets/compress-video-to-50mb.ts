  ...
  useCases: [
    {
      ...
      description: "Slack's free and Pro plans limit file uploads to 50 MB. Video updates, screen recordings, and demo clips compressed to 50 MB upload instantly.",
    },
    {
    ...
    },
    {
      ...
      description: '3–8 minute product walkthroughs and onboarding recordings compress well to 50 MB at 720p.',
    },
  ],
  specificFaq: [
    {
