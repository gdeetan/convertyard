export const meta = {
  ...
  faq: [
    ...
    },
    {
      ...
      a: "iLovePDF currently has OCR (optical character recognition for scanned PDFs) and e-signature tools. ConvertYard does not yet offer these. For most other PDF tasks, the tool coverage is comparable.",
    },
    {
    ...
    },
    {
      ...
      a: "Yes. Use ConvertYard for batch processing and privacy-sensitive documents. Use iLovePDF for tasks ConvertYard doesn't yet cover (OCR, e-sign). There's no registration required for either.",
    },
  ],
...
> **Note before publishing:** Verify iLovePDF's current free-tier file-size and task limits at ilovepdf.com — these change and the comparison should cite current numbers.
...
> **Revise this section after OCR ships** (scheduled in the build queue).
