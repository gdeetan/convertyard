export const meta = {
  ...
  faq: [
    ...
    },
    {
      ...
      a: 'Up to a point. Most people cannot distinguish 192 kbps from 320 kbps in a double-blind test. The audible ceiling depends on the format: 128 kbps AAC often sounds as good as 192 kbps MP3 because AAC uses a more efficient compression algorithm. Above the audible ceiling, increasing bitrate only increases file size.',
    },
    {
