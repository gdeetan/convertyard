export const meta = {
  ...
  relatedTools: ['image-compressor', 'jpg-to-webp'],
}
...
**[Compress images in your browser — no uploads →](/image-compressor/)**
...
1. Go to [ConvertYard's image compressor](/image-compressor/).
