...
<BeforeAfterCompare
  beforeSrc="/articles/compress-images-without-losing-quality/livestock-lossy-jpg-q50.jpg"
  beforeAlt="Livestock field illustration saved as lossy JPG at quality 50"
  beforeLabel="JPG lossy q50 · 70 KB"
  afterSrc="/articles/compress-images-without-losing-quality/livestock-lossless-avif.avif"
  afterAlt="Same illustration saved as lossless AVIF at quality 50, effort 7"
  afterLabel="AVIF lossless · 21 KB (−70%)"
  aspectRatio="1400 / 904"
  caption="Both files are compressed at 50% quality, but the end result is the lossless version is more than three times smaller than the lossy."
/>
