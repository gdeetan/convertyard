export const meta = {
  ...
  faq: [
    ...
    },
    {
      ...
      a: 'Windows needs the "HEIF Image Extensions" codec installed from the Microsoft Store before it can open HEIC files. Even with the codec, many third-party applications (older Photoshop, Lightroom before 2019, Gimp before 2.10) cannot read HEIC. Converting to JPG or PNG is the reliable solution for cross-platform use.',
    },
    {
