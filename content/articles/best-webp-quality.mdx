...
<div className="my-6 flex justify-center">
  <img src="/articles/best-webp-quality/jpg-to-webp-settings.png" alt="JPG to WebP conversion settings used for this test" width={1440} height={1694} loading="lazy" decoding="async" className="max-w-full h-auto" />
</div>
