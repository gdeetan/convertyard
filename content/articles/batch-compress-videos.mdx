...
<img
  src="/articles/batch-compress-videos/batch-video-compressor.webp"
  alt="ConvertYard batch video compressor interface with multiple files queued"
  className="my-6 w-[110%] max-w-none md:-ml-[5%] rounded-xl border border-border"
  loading="lazy"
/>
