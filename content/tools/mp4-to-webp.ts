...
export const config: ToolConfig = {
  ...
  faq: [
    ...
    },
    {
      ...
      a: 'No. Conversion runs entirely in your browser using ffmpeg.wasm. Your video stays on your device the whole time.',
    },
    {
      q: 'Can I batch-convert multiple MP4 files at once?',
      a: 'Yes. Drop several short clips and ConvertYard will process them one by one in your browser, then package the results for download.',
    },
  ],
