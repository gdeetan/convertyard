...
export const config: ToolConfig = {
  ...
  subtitle: 'Upscale 2× or 4× using AI. Runs in your browser. No account needed.',
  category: 'ai',
  ...
  faq: [
    {
      ...
      a: 'Yes. Standard resizing (bicubic) blurs the image. AI upscaling (SwinIR) predicts and adds realistic detail — sharper edges, clearer textures — especially on photos and product images.',
    },
    {
    ...
    },
    {
      ...
      a: 'Yes. SwinIR handles faces well. It works best on front-facing, reasonably lit portraits. Very dark or blurry source images will still upscale but with less detail recovery.',
    },
    {
      q: 'What scale should I use for printing?',
      a: '4× is recommended for printing web images. A 500×500 px web image becomes 2000×2000 px — suitable for a 6×6 inch print at 300 DPI.',
    },
    {
    ...
    },
    {
      ...
      a: 'Up to 200 files recommended. Each file is processed sequentially in your browser. Processing time scales with image dimensions and your device GPU/CPU.',
    },
  ],
  ...
  meta: {
    ...
    description:
      'Upscale images 2× or 4× with AI in your browser. Powered by SwinIR. No upload, no account. Batch up to 200 files.',
  },
}
