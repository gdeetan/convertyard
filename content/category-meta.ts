...
export const CATEGORY_META: Record<string, CategoryMeta> = {
  ...
  'image-editing': {
    ...
    subtitle: 'Local-first image editing. Built for batches.',
    description: 'Resize, compress, and remove backgrounds from images — entirely in your browser. Drop 1 file or 1,000. Nothing leaves your device.',
    seoTitle: 'Image Editing Tools — ConvertYard',
    seoDescription: 'Batch resize, compress, and remove backgrounds from images in your browser. Up to 1,000 files at once — no uploads, no watermarks.',
    faq: [
      { q: 'Do my images get uploaded to a server?', a: 'No. All processing happens in your browser using WebAssembly. Your files never leave your device.' },
      { q: 'How many images can I edit at once?', a: 'Up to 1,000 files per batch. Each file is processed in parallel where your device supports it.' },
      { q: 'What image editing tools are available?', a: 'Image Compressor, Image Resizer, and Background Remover. More tools are in development.' },
      { q: 'Are the edited images watermarked?', a: 'Never. ConvertYard does not add watermarks. What you edit is what you get.' },
      { q: 'Does the AI background remover need an internet connection?', a: 'No. The AI model runs locally in your browser using transformers.js. No data is sent to a server.' },
    ],
  },
  'image-to-text': {
    ...
    description: 'Extract text from any image — screenshots, photos, scans, receipts, business cards, handwritten notes. All 12 tools run entirely in your browser using WebAssembly. No uploads, no account, no file size limits.',
    seoTitle: 'Image to Text Converter — ConvertYard',
    seoDescription: 'Free online OCR: extract text from images, screenshots, photos, and scans. Batch up to 500 files. Runs in your browser — nothing uploaded.',
    faq: [
      { q: 'Are my images uploaded to a server?', a: 'No. OCR runs entirely in your browser using WebAssembly and transformers.js. Your files never leave your device.' },
      { q: 'How many images can I process at once?', a: 'Up to 500 images per session with no daily limit. Each file gets its own result with a confidence score.' },
      { q: 'Which languages are supported?', a: '60+ languages including English, Spanish, French, German, Chinese (Simplified and Traditional), Japanese, Korean, Arabic, and Hindi. Select from the dropdown or leave it on Auto-detect.' },
      { q: 'How accurate is the text extraction?', a: 'For clean digital images — screenshots, scanned documents, printed text — accuracy is typically 95–99%. Each result shows a confidence indicator so you can spot low-quality extractions immediately.' },
      { q: 'Does it work on handwriting?', a: 'Yes — use the Handwriting to Text tool, which uses a model trained specifically on handwritten content rather than the general-purpose document OCR engine.' },
      { q: 'What output formats are available?', a: 'Plain .txt, Markdown (.md), combined text file (all pages merged), CSV for structured tools like Receipt to Text and Image to Excel, and .xlsx via the Image to Excel tool.' },
      { q: 'Can I extract tables from images?', a: 'Yes. Use Image to Excel for .xlsx output, Table Image to Text for CSV/TSV, or Receipt to Text for expense data with vendor, date, and amount fields pre-parsed.' },
      { q: 'Does it work offline?', a: 'Once the page has loaded and the model is cached by your browser, yes — OCR runs locally so no internet connection is needed for subsequent sessions.' },
    ],
  },
  'ai-tools': {
    slug: 'ai-tools',
