export function ExifViewerExplainer() {
  return (
    <div>
      ...
      <p>
        This tool will automatically detect all four of these. However, metadata can be stripped
        from an image, so the absence of these indicators doesn&rsquo;t mean the photo isn&rsquo;t
        AI-generated. You can use a tool like <a href="/ai-image-detector">AI Image Detector</a> to
        check. It won&rsquo;t be 100% accurate, but I&rsquo;ve tested it extensively on images
        generated by AI image generators like ChatGPT, and it flagged them.
      </p>
