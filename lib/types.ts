...
export interface ToolConfig {
  ...
  presetBar?: React.ComponentType<{ onApply: (values: ToolOptions) => void; currentValues?: ToolOptions }> // hardcoded quick-start presets (renders below OptionsPanel)
...
export interface SizeTargetConfig {
  parentTool: 'compress-pdf' | 'compress-image' | 'compress-video' | 'compress-mp3'
  targetBytes: number
  targetLabel: string
  slug: string
  h1: string
